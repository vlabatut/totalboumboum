...
public class GuiKeys
{
	...
	public static final String MENU_OPTIONS = MENU+OPTIONS;
		...
		public static final String MENU_OPTIONS_AIS_TITLE = MENU_OPTIONS_AIS+TITLE;
			...
			public static final String MENU_OPTIONS_AIS_LINE = MENU_OPTIONS_AIS+LINE;
				...
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE = MENU_OPTIONS_AIS_LINE+TOURNAMENT+AUTO+ADVANCE+MODE;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_TITLE = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+TITLE;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_CONFRONTATIONS = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+CONFRONTATIONS;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_CONSTANT = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+CONSTANT;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_PACK = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+PACK;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_RANDOM = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+RANDOM;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_RANKS = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+RANK;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_NEXT = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+NEXT;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE_PREVIOUS = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_MODE+PREVIOUS;
				/** TOURNAMENT AUTO ADVANCE PACK */
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK = MENU_OPTIONS_AIS_LINE+TOURNAMENT+AUTO+ADVANCE+PACK;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK_TITLE = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK+TITLE;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK_NEXT = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK+NEXT;
				public static final String MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK_PREVIOUS = MENU_OPTIONS_AIS_LINE_TOURNAMENT_AUTO_ADVANCE_PACK+PREVIOUS;
				/** UPS */
				...
				/** RECORD STATS */
				public static final String MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS = MENU_OPTIONS_AIS_LINE+RECORD+STATISTICS;
				public static final String MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS_TITLE = MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS+TITLE;
				public static final String MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS_DISABLED = MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS+DISABLED;
				public static final String MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS_ENABLED = MENU_OPTIONS_AIS_LINE_RECORD_STATISTICS+ENABLED;
		/** CONTROLS */
	...
	public static final String MENU_TOURNAMENT = MENU+TOURNAMENT;
		...
		public static final String MENU_TOURNAMENT_LOAD_TITLE = MENU_TOURNAMENT_LOAD+TITLE;
			...
			public static final String MENU_TOURNAMENT_LOAD_BUTTON_STATISTICS = MENU_TOURNAMENT_LOAD_BUTTON+STATISTICS;
	...
	/** GAME */
		...
		public static final String GAME_MATCH = GAME+MATCH;
			...
			public static final String GAME_MATCH_BUTTON_PREVIOUS_ROUND = GAME_MATCH_BUTTON+PREVIOUS+ROUND;
		...
		public static final String GAME_ROUND = GAME+ROUND;
			...
			public static final String GAME_ROUND_BUTTON_NEXT_MATCH = GAME_ROUND_BUTTON+NEXT+MATCH;
			public static final String GAME_ROUND_BUTTON_NEXT_ROUND = GAME_ROUND_BUTTON+NEXT+ROUND;
			public static final String GAME_ROUND_BUTTON_PLAY = GAME_ROUND_BUTTON+PLAY;
			public static final String GAME_ROUND_BUTTON_PREVIOUS_ROUND = GAME_ROUND_BUTTON+PREVIOUS+ROUND;
	...
	public static final String COMMON_EVOLUTION = COMMON+EVOLUTION;
		...
		public static final String COMMON_EVOLUTION_BUTTON_BOMBEDS = COMMON_EVOLUTION_BUTTON+BOMBEDS;
		public static final String COMMON_EVOLUTION_BUTTON_ITEMS = COMMON_EVOLUTION_BUTTON+ITEMS;
		public static final String COMMON_EVOLUTION_BUTTON_BOMBINGS = COMMON_EVOLUTION_BUTTON+BOMBINGS;
		public static final String COMMON_EVOLUTION_BUTTON_PAINTINGS = COMMON_EVOLUTION_BUTTON+PAINTINGS;
	...
	public static final String COMMON_TOURNAMENT_TYPE = COMMON_TOURNAMENT+TYPE;
		...
		public static final String COMMON_TOURNAMENT_TYPES_TURNING = COMMON_TOURNAMENT_TYPES+TURNING;
