...
//System.out.println("droppedBombs.size(): "+droppedBombs.size());	
			...
			{	if(bomb!=null)
				{	bomb.setFlameRange(flameRange); // maybe it should be more consistent to use a specific StateAbility, initialized automatically from the owner when the bomb is made (by the bombfactory)?
