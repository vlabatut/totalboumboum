...
// vérififier dans le mod mgr que c bien cette méthode (et pas la parente) qui est appelée
...
*/		//	
	...
	{	GeneralAction actionCopy = action;
		ThirdModulation result = new ThirdModulation(actionCopy); // why copy the action?
		// restrictions
