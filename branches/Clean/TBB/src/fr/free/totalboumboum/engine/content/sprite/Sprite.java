...
*/	
	...
	{	return owner;
		// à modifier pour recherche récursivement l'owner final (mais peut être est-ce déjà fait ailleurs)
	}
...
//			eventManager.update();
		...
		/*
		 *  : il est important que le trajectoryManager soit updaté en dernier
