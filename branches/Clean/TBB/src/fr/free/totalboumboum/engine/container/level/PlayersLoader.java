...
{	
	...
	{	
    	/* 
		 *  tester ici si le level est suffisamment grand
		 *  faut qu'il y ait au moins une config, à définir dans XSD
		 * attention, le numéro des joueurs ne doit pas dépasser maxPlayer-1
		 *  il faut tester qu'il y a bien autant de locations de que de players indiqué dans la situation
		 */
