...
{	
	...
	{	gesture = GestureName.APPEARING;
		sprite.setGesture(gesture,spriteDirection,Direction.NONE,true);
		EngineEvent event = new EngineEvent(EngineEvent.TILE_LOW_ENTER,sprite,null,sprite.getActualDirection()); // to be changed by a GESTURE_CHANGE event (or equiv.)
	...
	{	// randomly find a tile
		...
		{	gesture = GestureName.RELEASED;
			sprite.setGesture(gesture,spriteDirection,Direction.NONE,true);
			EngineEvent evt = new EngineEvent(EngineEvent.TILE_LOW_ENTER,sprite,null,sprite.getActualDirection()); // to be changed by a GESTURE_CHANGE event (or equiv.)
