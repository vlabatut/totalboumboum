...
/**
 * classe chargée d'implémenter un déplacement, en respectant un chemin donné
 * 
 * @version 5
 * 
...
public class PathController {
	...
	public boolean hasArrived() throws StopRequestException {
		...
		// if(!arrived)
		{ // on teste si le personnage est à peu près situé à la position de
			// destination
	...
	/**
	 * met à jour la position précédente du personnage, exprimée en pixels
	 * 
	 * @throws StopRequestException
	 *             Description manquante !
	 */
	 ...
	 * le chemin, alors le chemin est vide après l'exécution de cette méthode.
	 * 
	 * @throws StopRequestException
	 *             Description manquante !
	 */
	...
	/**
	 * détermine si le personnage a dépassé la première case du chemin en
	 * direction de la seconde case
	 * 
	 * 
	 * /** teste si le chemin est toujours valide, i.e. s'il est toujours sûr et
	 * si aucun obstacle n'est apparu depuis la dernière itération
	 * 
