...
{	/** classe principale de l'IA, permet d'accÔøΩder ÔøΩ checkInterruption() */
	...
	public Matrix constructInterestMatrix() throws StopRequestException
	{
		 ...
		 * Dans la 2e, grace au nature des clés, on va les separer aux couches. Chacun des bombes dans un couche va "attirer" les bombes dans les couches superieures qu'ils peuvent declencher.
		 * Celle-ci signifie que les bombes aux couches superieures peuvent etre detruites plus tot.
		 * Finalament, on va ajouter les valeurs dans la matrice d'interet.
		 * 
