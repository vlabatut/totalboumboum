...
public class MovementCommitter {
	...
	public AiAction commitMovement(Matrix m,boolean invokedForSafeBombPlacement) throws StopRequestException
	{
		...
		AiAction result=choosePath(m,changedUpTo,hI,hJ,hval,invokedForSafeBombPlacement);
	 ...
	 */
	private AiAction choosePath(Matrix m,int changedUpTo,int[] hI,int[] hJ,double[] hval,boolean invokedForSafeBombPlacement) throws StopRequestException
	{
		monIA.checkInterruption();
		//a=4;
		//changedUpTo=4;
