package tournament200809old.tirtiltomruk.astaralgorithm;
...
import tournament200809old.tirtiltomruk.TirtilTomruk;
import tournament200809old.tirtiltomruk.zone.Zone;
import tournament200809old.tirtiltomruk.zone.ZoneEnum;
...
public class PathFinder {
	...
	public PathFinder(AiZone zone, AiTile target,TirtilTomruk source) throws StopRequestException
	{
	...
	{	source.checkInterruption(); //Appel Obligatoire
		...
		while((solution == null) && (!frange.isEmpty())){  
			...
			//la case qui est en bas de lui.
				if((temp.getY()+1<=13)&& (tab[temp.getX()][temp.getY()+1]!=ZoneEnum.FEU) && (tab[temp.getX()][temp.getY()+1]!=ZoneEnum.BOMBE)&&(tab[temp.getX()][temp.getY()+1]!=ZoneEnum.BLOCDEST)&&(tab[temp.getX()][temp.getY()+1]!=ZoneEnum.BLOCINDEST)) {
			...
			//la case qui est à droite de lui.
				if((temp.getX()+1<=15)&& (tab[temp.getX()+1][temp.getY()]!=ZoneEnum.FEU) && (tab[temp.getX()+1][temp.getY()]!=ZoneEnum.BOMBE)&&(tab[temp.getX()+1][temp.getY()]!=ZoneEnum.BLOCDEST)&&(tab[temp.getX()+1][temp.getY()]!=ZoneEnum.BLOCINDEST)){
