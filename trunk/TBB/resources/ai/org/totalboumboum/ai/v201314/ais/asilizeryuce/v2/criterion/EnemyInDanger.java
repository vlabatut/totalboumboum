...
/** 
 * Cette critere entier pour savoir que est-ce que la case ou on veut mettre une bombe 
 * est propre de tuer l'ennemi ou on veut mettre une bombe 
 *  
 * @author Emre Asıl 
 * @author Tülin İzer 
 * @author Miray Yüce 
...
public class EnemyInDanger extends AiCriterionInteger<Agent> {
	...
	public Integer processValue(AiTile tile) {
		ai.checkInterruption();
		int result = 2;
		if (this.ai.getEnemyInColumn(tile) == 2)
			return 1;
