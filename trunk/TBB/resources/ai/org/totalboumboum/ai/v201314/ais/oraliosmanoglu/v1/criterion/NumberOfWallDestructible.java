 ...
 *
 *cette critere nous envoyer la nombre de murs (integer (0,1,2 ou 3))destructibles autour de case.
 *
 */
public class NumberOfWallDestructible extends AiCriterionInteger<Agent>
{	
	/** */
	public static final String NAME = "Criter_Mur";
	...
	int result = 0;
	//on prend les tiles pour les voisins de cette tile(droit ,gauche, haut, bas)
	...
	{ 
		ai.checkInterruption();
		if(blocks.getTile()==right || blocks.getTile()==left || blocks.getTile()==up ||blocks.getTile()==down ) 
			result++;
    }
	if(result == 4)
	{
