 ...
 * @author Yyyyyy
 */
public class EmreogluOzturk extends ArtificialIntelligence
{
	/**
	 * Instancie la classe principale de l'agent.
	 */
	public EmreogluOzturk()
	...
	@Override
	protected AiModeHandler<EmreogluOzturk> getModeHandler() throws StopRequestException
	{	checkInterruption();
		return modeHandler;
	}

	@Override
	protected AiPreferenceHandler<EmreogluOzturk> getPreferenceHandler() throws StopRequestException
	{	checkInterruption();
		return preferenceHandler;
	}

	@Override
	protected AiBombHandler<EmreogluOzturk> getBombHandler() throws StopRequestException
	{	checkInterruption();
		return bombHandler;
	}

	@Override
	protected AiMoveHandler<EmreogluOzturk> getMoveHandler() throws StopRequestException
	{	checkInterruption();
		return moveHandler;
	}
