...
/**
 * This class receives a pattern and coordinates of an enemy by it's constructor method "patterns":
 * 		
 * 
 * if an enemy location corresponds to a pattern described in this class,
 * then it returns the coordinates of 3 tiles with tilesXY[]
...
public class Patterns{
	 ...
	 */
    	...
    	/**
    	 * Constructer method of this class
    	 * @param ai for using checkinterruption
    	 ...
    	 */
    	public Patterns(int[] testPattern, int xAdv, int yAdv, Agent ai){
