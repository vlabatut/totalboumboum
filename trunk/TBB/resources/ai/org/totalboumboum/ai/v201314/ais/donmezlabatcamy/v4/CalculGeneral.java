...
public class CalculGeneral extends AiAbstractHandler<Agent> {
	...
	/**
	 * Calcule l'existence de murs destructible dans les cases voisines s'il n'existe pas d'adversaires dans notre liste de sélection de case
	 * 
	 * @return true s'il existe un mur destructible dans au moins une des cases voisines false sinon
	 */
	 ...
	 * 
	 * @return true s'il existe au moins un mur destructible dans la portée de notre bombe false sinon
	 */
	 ...
	 * @param tile
	 *            case cible
	 * @return true si l'agent sera capable d'atteindre la case avant l'adversaire false sinon
	 */
	...
	/**
	 * Calcule et met à jour le temps qui reste à une bombe d'exploser si elle a
	 * été déclenchée par l'explosion d'une bombe posée précedemment.
	 * 
	 * @param tile
	 *            case concernée
	...
	/**
	 * Calcule la durée d'explosion de la bombe si la case passée en paramètres est 
     * une case dangereuse sinon elle renvoie la durée d'explosion de la bombe.
	 * 
	 * @param tile
	 *            case concernée
	 * @return result Le temps d'explosion de la bombe
	 ...
	 * @param tile
	 *            case concernée
	 * @return 0 si il y a 1 ou 0 mur sur les cases voisines 1 si il y a 2 murs 2 sinon
	 */
	 ...
	 * 
	 * @return true si la réaction en chaine est possible false sinon
	 */
	...
	/**
	 * Calcule la possibilitée d'éliminer l'adversaire en vérifiant si celui-ci se trouve dans la portée de la bombe qu'il a posé et si cette case est dans l'intersection de la
	 * portée de la bombe de notre agent.
	 * 
	 * @return true si cette stratégie est applicable false sinon
	 */
	...
	/**
	 * Vérifie si l'agent est dans la portée de sa première bombe posée, pour empêcher l'oscillation
	 * 
	 * @return true si l'agent est dans la portée de cette bombe false sinon
	 */
	 ...
	 * 
	 * @return true si il y a beaucoup de bombe false sinon
	 */
