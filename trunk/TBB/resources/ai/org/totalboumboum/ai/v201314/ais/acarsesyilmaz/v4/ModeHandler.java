...
{	
	...
	{	
		...
		if(ai.itemHandler.isBonusReachable() && (ai.getZone().getOwnHero().getBombNumberCurrent() == 0 || ai.getZone().getOwnHero().getBombRange() == 0))
		{
			result = true;
		}		
		else if(ai.itemHandler.isBonusReachable())
		{
			ai.securityHandler.updateAccessibleTiles();
