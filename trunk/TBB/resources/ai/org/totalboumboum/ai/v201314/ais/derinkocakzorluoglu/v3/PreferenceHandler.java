...
{	
	...
	{	ai.checkInterruption();
		...
		{	// par exemple ici, on utilise la présence d'un item pour déterminer le cas
			...
			if(ai.enemyAccessible) //on applique le premier categorie quand l'ennemie est accessible
				result = getCategory(CAT_NAME_1);
			else //on applique le deuxieme categorie quand l'ennemie est inaccessible
