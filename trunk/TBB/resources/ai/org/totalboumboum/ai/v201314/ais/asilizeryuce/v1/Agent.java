...
public class Agent extends ArtificialIntelligence {
	/** tiles accessibles, retourne une list de ces tiles */
	...
	public ArrayList<AiTile> enemyTiles() {
	 ...
	 /** 
     * @param tile qu'on veut savoir si on pose une bombe dans ce tile, 
     * est-ce que cette bombe peut tuer l'adversaire, ou elle peut menacer l'adversaire. 
     * on controle le colonne selon la portee de notre bombe 
     * 
     * @return 0 s'il ya une ennemi dans cette colonne et 1 s'il n'y a pas d'ennemi dans cette cologne.
     */
	public int getEnemyInColumn(AiTile tile) {
		...
		for (int i = 0; i < range; i++) {
			...
			if (this.enemyTiles().contains(tile2))
				return 0;
		}
     ...
     * @param tile qu'on veut savoir si on pose une bombe dans ce tile, 
     * est-ce que cette bombe peut tuer l'adversaire, ou elle peut menacer l'adversaire. 
     * @return  0 s'il ya une ennemi dans cette ligne et 1 s'il n'y a pas d'ennemi dans cette ligne.
     */
