...
public class Agent extends ArtificialIntelligence
{
    ...
    protected void updatePercepts()
    {
        ...
        zoneHandler.verbose = false;
        criterionHandler.verbose = false;
        // cf. la Javadoc dans ArtificialIntelligence pour une description de la
        // méthode
    }
    ...
    /** Handles zone and tiles */
    public ZoneHandler zoneHandler;
    /** Helps to criterion calculations  */
    public CriterionHandler criterionHandler;
    /** Responsible from finding a path */
    ...
    protected void initHandlers()
    {
        ...
        criterionHandler = new CriterionHandler(this);
