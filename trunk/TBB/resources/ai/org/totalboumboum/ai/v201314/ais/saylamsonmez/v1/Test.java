...
import org.totalboumboum.ai.v201314.ais.saylamsonmez.AiMain;
import org.totalboumboum.tools.images.PredefinedColor;
import org.xml.sax.SAXException;

/**
 * Cette classe est un exemple de la manière de tester un agent hors-ligne,
 * c'est à dire sans lancer le jeu lui-même. L'intérêt est de pouvoir définir
 * programmatiquement exactement la zone que l'on veut en utilisant
 * {@link AiSimZone} : on peut placer tous les objets et agents où on veut, dans
 * l'état qu'on veut. Pour cet exemple, on utilise la zone créée dans les
 * exemples de l'API, i.e. la classe {@link InitData}. <br/>
 * La limitation est qu'on ne peut pas enchaîner des actions : pour ça on a
 * besoin du moteur du jeu, bien sûr. Donc ce genre de test doit passer par le
 * jeu complet, pas seulement l'API.
 * 
...
public class Test {
	...
	public static void main(String args[]) throws IllegalArgumentException,
			...
			SAXException, IOException, URISyntaxException { // on initialise la
															// zone (cf.
															// InitData)
