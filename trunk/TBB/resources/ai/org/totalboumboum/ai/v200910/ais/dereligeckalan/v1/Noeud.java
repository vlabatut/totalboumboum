...
public class Noeud {
		 ...
		 * @throws org.totalboumboum.ai.v200910.adapter.communication.StopRequestException 
		 */
		public Noeud(int x, int y, ZoneEnum valeur, int cout,DereliGeckalan source) throws StopRequestException, org.totalboumboum.ai.v200910.adapter.communication.StopRequestException {
			super();
			source.checkInterruption(); //Appel Obligatoire
			this.source = source;
			this.x = x;
		 ...
		 * @throws StopRequestException 
		 */
		public Noeud(int x, int y, ZoneEnum valeur, DereliGeckalan source) throws StopRequestException {
			super();
			source.checkInterruption(); //Appel Obligatoire
			this.source = source;
			this.x = x;
