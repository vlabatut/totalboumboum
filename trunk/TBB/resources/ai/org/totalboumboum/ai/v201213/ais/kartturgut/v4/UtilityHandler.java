...
{	
	...
	AiUtilityCase casBloquerAdversaire = new AiUtilityCase(ai,Case1, criteria);
	...
	AiUtilityCase casMurDestructible = new AiUtilityCase(ai,Case4, criteria4);
	...
	AiUtilityCase casVoisinageAdversaire = new AiUtilityCase(ai,Case7, criteria7);
