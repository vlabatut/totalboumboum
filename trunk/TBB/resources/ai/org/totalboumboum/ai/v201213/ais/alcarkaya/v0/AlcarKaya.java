package org.totalboumboum.ai.v201213.ais.alcarkaya.v0;
 ...
 * @author Ulaş Kaya
 */
public class AlcarKaya extends ArtificialIntelligence
{
	@Override
	...
	@Override
	protected AiModeHandler<AlcarKaya> getModeHandler() throws StopRequestException
	{	checkInterruption();
		return modeHandler;
	}

	@Override
	protected AiUtilityHandler<AlcarKaya> getUtilityHandler() throws StopRequestException
	{	checkInterruption();
		return utilityHandler;
	}

	@Override
	protected AiBombHandler<AlcarKaya> getBombHandler() throws StopRequestException
	{	checkInterruption();
		return bombHandler;
	}

	@Override
	protected AiMoveHandler<AlcarKaya> getMoveHandler() throws StopRequestException
	{	checkInterruption();
		return moveHandler;
	}
