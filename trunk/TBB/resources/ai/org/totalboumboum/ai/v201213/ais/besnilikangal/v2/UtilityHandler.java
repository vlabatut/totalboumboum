...
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.Bloque;
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.Concurrence;
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.Duree;
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.NombreDesMurs;
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.Pertinence;
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.PlusFacile;
import org.totalboumboum.ai.v201213.ais.besnilikangal.v2.criterion.PlusFaible;
...
{	
	...
	protected Set<AiTile> selectTiles() throws StopRequestException
	{
		...
		if ( ai.getModeHandler().getMode() == AiMode.COLLECTING )
			return ai.tileOperation.getSafeTiles();
		else
