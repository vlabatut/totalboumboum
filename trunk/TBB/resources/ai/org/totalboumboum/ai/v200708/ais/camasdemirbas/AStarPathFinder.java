...
/**
 * Une implément de viseur de chemin qui utilise l'AStar l'algorithme basé
 * heuristique déterminer un chemin.
 * 
 * @author Gökhan Çamaş
...
public class AStarPathFinder implements PathFinder {
	...
	/**
	 * L'heuristique nous appliquons nous déterminer quels noeuds pour chercher
	 * premièrement
	 */
	private AStarHeuristic heuristic;

	/**
	 * créer un viseur de chemin avec l'implicite heuristique - le plus proche
	 * pour cibler.
	 * 
	 * @param map
	 *            La carte être cherchée
	 ...
	 * 
	 * @param heuristic
	 *            L'heuristique a utilisé pour déterminer l'ordre de recherche
	 *            de la carte
	 * @param map
	 *            La carte être cherchée
	 * @param maxSearchDistance
	...
	/**
	 * Obtenir le premier élément de la liste ouverte. Ceci est le suivant être
	 * cherché.
	 * 
	 ...
	 * 
	 * @param node
	 *            Le noeud être ajouté à la liste ouverte
	 */
	 ...
	 * 
	 * @param node
	 *            Le noeud pour ajouter à la liste fermée
	 */
	 ...
	 * 
	 * @param node
	 *            Le noeud pour enlever de la liste fermée
	 */
	...
	/**
	 * Obtenir le coût heuristique pour l'emplacement donné. Ceci détermine dans
	 * lequel commande les emplacements sont traités.
	 * 
	 * @param x
	 *            Description manquante !
	 * @param y
