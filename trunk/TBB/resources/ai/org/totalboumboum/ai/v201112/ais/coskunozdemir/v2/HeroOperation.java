...
public class HeroOperation
{
	...
	protected boolean isHeroInDanger() throws StopRequestException
	{
		...
		if ( to.getCurrentDangerousTiles().contains( this.ai.getZone().getOwnHero().getTile() ) ) return true;
		return false;
	}
	...
	protected boolean isHeroInRange() throws StopRequestException
	{
		...
		return isHeroInRange( this.ai.getZone().getOwnHero() );
	}
	...
	{
		ai.checkInterruption();
		return this.canReachSafety( this.ai.getZone().getOwnHero() );
	}
