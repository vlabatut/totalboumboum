...
{	/** Nom de ce critère */
	...
	if(blockL.size()>0){
		int shortest = distance(blockL.get(0).getTile().getNeighbor(Direction.UP).getCol(), blockL.get(0).getTile().getNeighbor(Direction.UP).getRow(), ownHero.getCol(), ownHero.getRow());
