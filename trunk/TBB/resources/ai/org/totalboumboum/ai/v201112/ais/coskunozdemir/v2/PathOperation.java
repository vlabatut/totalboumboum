...
public class PathOperation
{
	 ...
	 */
	protected AiPath getShortestPath( AiTile endTile ) throws StopRequestException, LimitReachedException
	{
		ai.checkInterruption();
		return this.getShortestPath( this.ai.getZone().getOwnHero(), endTile );
	}
	 ...
	 * @throws LimitReachedException
	 */
	protected AiPath getShortestPath( AiHero hero, AiTile endTile ) throws StopRequestException, LimitReachedException
	{
		ai.checkInterruption();
		CostCalculator costCalculator = new TimeCostCalculator( ai, this.ai.getZone().getOwnHero() );
		costCalculator.setOpponentCost( ASTAR_COST );
		HeuristicCalculator heuristicCalculator = new TimeHeuristicCalculator( ai, this.ai.getZone().getOwnHero() );
		SuccessorCalculator successorCalculator = new TimePartialSuccessorCalculator( ai, TimePartialSuccessorCalculator.MODE_NOTREE );
		Astar astarPrecise = new Astar( ai, this.ai.getZone().getOwnHero(), costCalculator, heuristicCalculator, successorCalculator );

		AiLocation loc = new AiLocation( hero.getTile() );

		// Shortest path calculation
		return astarPrecise.processShortestPath( loc, endTile );
	}
	 ...
	 * @throws LimitReachedException
	 */
	protected AiTile getNextTileOnPath( AiTile endTile ) throws StopRequestException, LimitReachedException
	{
		ai.checkInterruption();
		return this.getNextTileOnPath( this.ai.getZone().getOwnHero(), endTile );
	}
	 ...
	 * @throws LimitReachedException
	 */
	protected AiTile getNextTileOnPath( AiHero hero, AiTile endTile ) throws StopRequestException, LimitReachedException
	{
		ai.checkInterruption();
	 ...
	 * @throws LimitReachedException
	 */
	protected Direction getNextDirectionOnPath( AiTile endTile ) throws StopRequestException, LimitReachedException
	{
		ai.checkInterruption();
		return this.ai.getZone().getDirection( this.ai.getZone().getOwnHero().getTile(), this.getNextTileOnPath( endTile ) );
	}
	 ...
	 * @throws LimitReachedException
	 */
	protected Direction getNextDirectionOnPath( AiHero hero, AiTile endTile ) throws StopRequestException, LimitReachedException
	{
		ai.checkInterruption();
