package tournament200910.aksoytangay.v5_1;
...
public class AttackManager {
	...
	public AttackManager(AksoyTangay myAI, AiZone percepts, Zone zone, PathManager pathManager, AttackType attackType) throws StopRequestException
	{
		myAI.checkInterruption();
	...
	public AiHero getHeroToAttackFonx() throws StopRequestException
	{
		...
		//Sysem.out.println(heros.toString());
...
//				path.getTiles().remove(0);
	...
	public AttackType attackTypeDefiner() throws StopRequestException
	{
		...
		//Sysem.out.println("heroToAttack : "+heroToAttack.toString());
...
//		int startCol = startTile.getCol();
	...
	public boolean placeChanged() throws StopRequestException
	{
		...
		//Sysem.out.println(heroToAttack.toString());				
