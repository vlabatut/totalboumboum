package tournament200910.dorukkupelioglu.v5_1;
				...
				else
				{
					...
					{	
						if(target.succeed())//si j'avais trouvé une chemin
						{
							...
							if(target.dropBomb())//une case avaliable(si une bombe explose ici, l'autre hero peut mourir) ou a cote d'un mur
							{
								...
								if(bomb.pathAvailable())//je peut trouver une chemin si je pose une bombe
								{
									...
									else
									{
										if(dk.getBombNumber()-dk.getBombCount()>0)
										{
											...
											System.err.println("bomba bıraktım");
										...
										else
										{
											...
											{
												escape=new Escape(this);
												System.err.println("bomba bırakacaktım ama burda tehlike var: escape çağır");
												target=null;
												bomb=null;
											}
										}
								...
								else
								{
									...
									{
										escape=new Escape(this);
										System.err.println("yanlış hesaplamışım: ecape çağır");
									}
									target=null;
									bomb=null;
									result=new AiAction(AiActionName.NONE);
						...
						else 
						{
							...
							{
								escape=new Escape(this);
								System.err.println("yol bozuldu ya da tehlike olabilir");
							}
							target=null;
							bomb=null;
						}
