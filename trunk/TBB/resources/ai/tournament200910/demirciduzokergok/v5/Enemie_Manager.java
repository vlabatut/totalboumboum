package tournament200910.demirciduzokergok.v5;
...
//				x=false;
	...
	public boolean sameposEnemie(){
	
		if(safe_map.returnMatrix()[zone.getOwnHero().getLine()][zone.getOwnHero().getCol()]==safe_map.ENEMIE){
			return true;
		}
