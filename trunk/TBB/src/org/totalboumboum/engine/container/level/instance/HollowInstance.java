...
import org.totalboumboum.engine.container.bombset.HollowBombset;
...
public class HollowInstance extends AbstractInstance implements Serializable
{	private static final long serialVersionUID = 1L;
	...
	// BOMBSET MAP		/////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////
	private HollowBombset bombset = new HollowBombset();

	public void loadBombset()
    {	String individualFolder = FilePaths.getInstancesPath()+File.separator+name+File.separator+FileNames.FOLDER_BOMBS;
    	bombset = FiresetMapLoader.loadFiresetMap(individualFolder);
   }
