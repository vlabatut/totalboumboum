...
{	
	...
	public static final String FILE_AUTOSAVE = "autosave";
	public static final String FILE_AUTOSAVE_BACKUP = "autosave_backup";
	public static final String FILE_BLOCK = "block";
	public static final String FILE_BLOCKS = "blocks";
	public static final String FILE_BLOCKSET = "blockset";
	public static final String FILE_BOMB = "bomb";
	public static final String FILE_BOMBS = "bombs";
	...
	public static final String FILE_CONFRONTATIONS = "confrontations";
	...
	public static final String FILE_FIRES = "fires";
	...
	public static final String FILE_FLOORS = "floors";
	...
	public static final String FILE_GAMES = "games";
	...
	public static final String FILE_GLICKO2 = "glicko2";
	...
	public static final String FILE_SAVES = "saves";
	public static final String FILE_SCHEMAS = "schemas";
	public static final String FILE_SEARCH = "search";
	public static final String FILE_SETTINGS = "settings";
	public static final String FILE_SOURCE = "src";
	...
	public static final String FILE_TOTALBOUMBOUM = "totalboumboum";
	public static final String FILE_TOURNAMENT = "tournament";
	public static final String FILE_TOURNAMENTS = "tournaments";
