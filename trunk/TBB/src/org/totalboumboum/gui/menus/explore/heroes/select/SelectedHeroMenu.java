...
{	private static final long serialVersionUID = 1L;
	...
	{	super(container, parent);
		...
		buttonBack = GuiButtonTools.createButton(GuiKeys.MENU_RESOURCES_HERO_BUTTON_BACK,buttonWidth,buttonHeight,fontSize,this);
		add(Box.createVerticalGlue());		
	...
	{	if(e.getActionCommand().equals(GuiKeys.MENU_RESOURCES_HERO_BUTTON_BACK))
		{	replaceWith(parent);
	    }
	} 
