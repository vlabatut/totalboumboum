 ...
 *
 */
public class PlayerStatisticsSplitPanel extends SplitMenuPanel
{	private static final long serialVersionUID = 1L; 

	private BufferedImage image;

	public PlayerStatisticsSplitPanel(MenuContainer container, MenuPanel parent)
	{	super(container,parent,BorderLayout.LINE_START,GuiSizeTools.VERTICAL_SPLIT_RATIO);
		...
		// panels
		setMenuPart(new PlayerStatisticsMenu(this,parent));
	}
