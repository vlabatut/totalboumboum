package org.totalboumboum.gui.menus.network.hero;
...
{	private static final long serialVersionUID = 1L;
	...
	{	super(container, parent);
		...
		buttonConfirm = GuiButtonTools.createButton(GuiKeys.MENU_NETWORK_PLAYERS_BUTTON_CONFIRM,buttonWidth,buttonHeight,fontSize,this);
		add(Box.createRigidArea(new Dimension(0,GuiTools.buttonVerticalSpace)));
		buttonCancel = GuiButtonTools.createButton(GuiKeys.MENU_NETWORK_PLAYERS_BUTTON_CANCEL,buttonWidth,buttonHeight,fontSize,this);
		add(Box.createVerticalGlue());		
