...
public class TournamentMenuSplitPanel extends SplitMenuPanel
{	private static final long serialVersionUID = 1L; 

	private BufferedImage image;
	
	public TournamentMenuSplitPanel(MenuContainer container, MenuPanel parent)
	...
	{	return ((TournamentMenu)getMenuPart()).initTournament();
	}

	public TournamentSplitPanel getTournamentPanel()
	{	return ((TournamentMenu)getMenuPart()).getTournamentPanel();
	}
