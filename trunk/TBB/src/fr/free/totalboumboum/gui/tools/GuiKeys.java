...
public class GuiKeys
{
	...
	public static final String MENU_OPTIONS = MENU+OPTIONS;
		...
		public static final String MENU_OPTIONS_STATISTICS_TITLE = MENU_OPTIONS_STATISTICS+TITLE;
			...
			public static final String MENU_OPTIONS_STATISTICS_DIALOG_TITLE = MENU_OPTIONS_STATISTICS+TITLE;
			public static final String MENU_OPTIONS_STATISTICS_DIALOG_QUESTION = MENU_OPTIONS_STATISTICS+QUESTION;			
		/* VIDEO */
