package fr.free.totalboumboum.gui.common.structure.subpanel.temp;
...
public class EntitledSubPanelTable extends EntitledSubPanel implements SubPanelTable
...
//		remove(2); 	// remove glue
	...
	private UntitledSubPanelTable getTable()
