...
import fr.free.totalboumboum.ai.nextadapter.ArtificialIntelligence;
import fr.free.totalboumboum.ai.nextadapter.communication.StopRequestException;
import fr.free.totalboumboum.ai.nextadapter.data.AiHero;
import fr.free.totalboumboum.ai.nextadapter.data.AiTile;
import fr.free.totalboumboum.ai.nextadapter.path.AiPath;
import fr.free.totalboumboum.ai.nextadapter.path.astar.cost.CostCalculator;
import fr.free.totalboumboum.ai.nextadapter.path.astar.heuristic.HeuristicCalculator;
import fr.free.totalboumboum.ai.nextadapter.path.astar.successor.BasicSuccessorCalculator;
import fr.free.totalboumboum.ai.nextadapter.path.astar.successor.SuccessorCalculator;
