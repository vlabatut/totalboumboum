...
/**
 * Cette classe est pour construire une relation entre un point et son cout donc
 * on sait le cout d'un point et on sait si ce point dans la gameZone est un
 * wallSoft
 * 
 * @author Serkan Şahin
...
public class PointFind {
	...
	public String nodeYazdir() {
		return "_X = " + rootPoint.x + " _Y = " + rootPoint.y + " Cost = "
				+ cost;
