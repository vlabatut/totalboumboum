...
import org.totalboumboum.ai.v201011.ais.akbulutkupelioglu.v4.comparator.TileComparator;
			...
			}else
			{
				...
				}else
				{
					try
					{
						...
						{
							AiTile nextTile = previousStrategy.getWaypoints().peek().getTile();
							if(safeTiles.contains(nextTile))
								path=astar.processShortestPath(ownTile, nextTile);
						}else
