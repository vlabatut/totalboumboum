package org.totalboumboum.ai.v201011.ais.ozdokerozen.v6_2;
...
public class TileControleur {
	 ...
	 * @throws StopRequestException 
	 */
	void ameliorePath(List<AiTile> path,AiPath pathOptimise,AiTile fin) throws StopRequestException{
		IA.checkInterruption();
	 ...
	 * @throws StopRequestException 
	 */
	public boolean estQueOnPoseBombe(AiTile placeABombe) throws StopRequestException{
		IA.checkInterruption();
