...
import org.totalboumboum.ai.v201314.ais.gunessaglamturgut.AiMain;
 ...
 * la zone que l'on veut en utilisant {@link org.totalboumboum.ai.v201314.adapter.model.full.AiSimZone} : on peut
 ...
 * de l'API, i.e. la classe {@link org.totalboumboum.ai.v201314.adapter.test.InitData}.
 * <br/>
...
public class Test {
	 ...
	 * Méthode de test.
	 *
	 * @param args Pas pris en compte.
	 * @throws Exception Problème quelconque.
	 */
	public static void main(String args[]) throws Exception {    // on initialise l'agent
...
//		zone = usePredefinedZone();			// ici on utilise une zone créée manuellement dans la méthode
	 ...
	 *
	 * @param aiMain On a besoin de l'objet déjà créé pour effectuer le chargement.
	 * @return La zone crée.
	 * @throws Exception Problème quelconque.
	 */
