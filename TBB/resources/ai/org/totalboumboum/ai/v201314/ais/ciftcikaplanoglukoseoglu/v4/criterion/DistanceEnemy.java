...
public class DistanceEnemy extends AiCriterionBoolean<Agent> {
	...
	/**
	 * Crée le critère binaire distance a l'ennemi. Cette classe va nous permettre de traiter une case par rapport au critere
 * binaire "distance a l'adversaire". Ce critére renvoie la valeur vrai si la case traitée est 
 * au plus a 4 case de distance manhattan de l'adversaire. 
	 * 
	 * @param ai
	 *            l'agent concerné.
	 */
