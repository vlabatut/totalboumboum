...
/**
 * Cette classe permet de calculer le nombre de murs qui pourront être détruit en posant
 * une bombe dans la case séléctionnée.
 * 
...
public class NbDestWall extends AiCriterionInteger<Agent> {
	 ...
	 * @return result le nombre de murs qui peuvent être détruit.
	 */
	@Override
