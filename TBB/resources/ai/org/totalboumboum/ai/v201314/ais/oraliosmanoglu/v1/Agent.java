 ...
 * Chaque agent doit hériter de cette classe. La méthode processAction est la méthode appelée par le 
 gestionnaire d'agents pour obtenir la prochaine action à effectuer. Cette méthode implémente 
 l'algorithme général spécifié en cours et ne doit être ni modifiée ni surchargée.
 */
public class Agent extends ArtificialIntelligence
{
 ...
 gestionnaires). **/
	...
	// PERCEPTS			/////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////
	/**Méthode permettant d'initialiser les percepts de l'agent, c'est-à-dire les différents objets stockés en 
 interne dans ses classes.**/
	@Override
