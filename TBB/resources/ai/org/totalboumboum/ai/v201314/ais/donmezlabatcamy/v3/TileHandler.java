...
public class TileHandler {
	...
	/**
	 * Vérifie si on a au moins une case hors de danger accessible.
	 * 
	 * @param givenHero
	 *            l'agent concernée
	 * @return true si il existe une case à échapper false sinon
	 */
	...
	/**
	 * Calcule la case hors de danger la plus proche de notre agent parmis toute les cases 
	 * de la zone de jeu.
	 * 
	...
	/**
	 * Calcule les cases qui sont en danger.
	 * 
	...
	/**
	 * Calcule l'importance de danger sur les cases au voisinage de l'agent.
	 * 
	 * @param hero
	 *            agent concernée
	 * @return true si les cases au voisinage sont en danger et si l'agent n'est pas sur une case de danger
	 * 		   false sinon
	 */
	 ...
	 * @param hero
	 *            agent concerné
	 * @return true si la direction est une case dangereuse
	 * 		   false sinon
	 */
	 ...
	 * @param tile
	 *            case concernée
	 * @return true si la case est dans un corridor
	 * 			false sinon
	 */
	 ...
	 * @param tile
	 *            case concernée
	 * @return true si la l'adversaire sera bloqué entre des murs et un adversaire
	 * 		   false sinon
	 */
