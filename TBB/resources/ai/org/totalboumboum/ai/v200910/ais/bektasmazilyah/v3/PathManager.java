...
public class PathManager
{
	 ...
	 * exprimée en pixels
	 */
	public PathManager(BektasMazilyah ai, double x, double y) throws StopRequestException
	 ...
	 * passée en paramètre
	 */
	public PathManager(BektasMazilyah ai, AiTile destination) throws StopRequestException
	{	ai.checkInterruption(); //APPEL OBLIGATOIRE
	 ...
	 */
	private void init(BektasMazilyah ai) throws StopRequestException
	{	ai.checkInterruption(); //APPEL OBLIGATOIRE
...
*/
	...
	{	ai.checkInterruption(); //APPEL OBLIGATOIRE
		...
		{	ai.checkInterruption(); //APPEL OBLIGATOIRE
			...
			int x=tile.getCol();
			int y=tile.getLine();
			result = tile.isCrossableBy(ai.getOwnHero()) && ai.isClear(x,y);
//			if(!result)
//				System.out.println();
		}
		return result;
