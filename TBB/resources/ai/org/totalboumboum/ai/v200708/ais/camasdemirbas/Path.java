...
/**
 * Un chemin résolu par quelque algorithme de conclusion de chemin. Un
 * feuilleton d'étapes de l'emplacement commençant à l'emplacement de cible.
...
public class Path {
	 ...
	 * 
	 * @param index
	 *            L'index de l'étape pour rapporter.
	 ...
	 * 
	 * @param index
	 *            l'index de l'étape dont y la coordonnée devrait être rapportée
	 * @return y
	 */
	 ...
	 * 
	 * @param x
	 *            la coordonnéede x de la nouvelle étape
	 * @param y
	 *            la coordonnéede y de la nouvelle étape
	 */
