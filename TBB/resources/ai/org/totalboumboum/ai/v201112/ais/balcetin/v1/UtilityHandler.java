...
import org.totalboumboum.ai.v201112.ais.balcetin.v1.criterion.DUREE;
import org.totalboumboum.ai.v201112.ais.balcetin.v1.criterion.CriterionSecond;
import org.totalboumboum.ai.v201112.ais.balcetin.v1.criterion.CriterionThird;
...
{	
	...
	{	
		...
		{	// on crée la combinaison (vide pour l'instant)
			...
			combi.setCriterionValue(duree,false);
		...
		{	combi = new AiUtilityCombination(case1);
			combi.setCriterionValue(duree,true);
			combi.setCriterionValue(criterionSecond,1);
			referenceUtilities.put(combi,utility);
			utility++;
		}
