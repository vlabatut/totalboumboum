...
public class TileOperation
{
	...
	private void fillAccessibleTilesBy( AiTile sourceTile ) throws StopRequestException
	{
		...
		if ( sourceTile.isCrossableBy( this.ai.getZone().getOwnHero() ) )
		{
			...
			if ( sourceTile.getNeighbor( Direction.UP ).isCrossableBy( this.ai.getZone().getOwnHero() ) && !this.accessibleTiles.contains( sourceTile.getNeighbor( Direction.UP ) ) ) fillAccessibleTilesBy( sourceTile.getNeighbor( Direction.UP ) );
			if ( sourceTile.getNeighbor( Direction.DOWN ).isCrossableBy( this.ai.getZone().getOwnHero() ) && !this.accessibleTiles.contains( sourceTile.getNeighbor( Direction.DOWN ) ) ) fillAccessibleTilesBy( sourceTile.getNeighbor( Direction.DOWN ) );
			if ( sourceTile.getNeighbor( Direction.LEFT ).isCrossableBy( this.ai.getZone().getOwnHero() ) && !this.accessibleTiles.contains( sourceTile.getNeighbor( Direction.LEFT ) ) ) fillAccessibleTilesBy( sourceTile.getNeighbor( Direction.LEFT ) );
			if ( sourceTile.getNeighbor( Direction.RIGHT ).isCrossableBy( this.ai.getZone().getOwnHero() ) && !this.accessibleTiles.contains( sourceTile.getNeighbor( Direction.RIGHT ) ) ) fillAccessibleTilesBy( sourceTile.getNeighbor( Direction.RIGHT ) );
		}
	}
	...
	{
		ai.checkInterruption();
		return this.getDangerousTilesOnBombPut( this.ai.getZone().getOwnHero().getTile(), this.ai.getZone().getOwnHero().getBombRange() );
	}
	...
	{
		ai.checkInterruption();
		return this.getAccessibleTilesWithinRadius( this.ai.getZone().getOwnHero().getTile(), radius );
	}
	...
	{
		ai.checkInterruption();
		return this.getClosestSafeTile( this.ai.getZone().getOwnHero().getTile(), checkRadius );
	}
	...
	public AiTile getClosestAccDesWalltoEnemy() throws StopRequestException
	{
		...
		double distance = Double.MAX_VALUE;
		AiTile result = null;
		for ( AiTile currentTile : this.getAccessibleDestructibleWallTiles( this.ai.getZone().getOwnHero().getTile() ) )
		{
			ai.checkInterruption();
	...
	public AiTile getClosestAttPertinentTile() throws StopRequestException
	{
		...
		{
			ai.checkInterruption();
			if ( this.getDangerousTilesOnBombPut( currentTile, this.ai.getZone().getOwnHero().getBombRange() ).contains( enemy.getTile() ) )
			{
		...
		{
			ai.checkInterruption();
			if ( this.getDistanceBetween( this.ai.getZone().getOwnHero().getTile(), currentTile ) < distance )
			{
				result = currentTile;
				distance = this.getDistanceBetween( this.ai.getZone().getOwnHero().getTile(), currentTile );
			}
		}
	...
	protected ArrayList<AiTile> getAccessibleTiles() throws StopRequestException
	{
		...
		fillAccessibleTilesBy( this.ai.getZone().getOwnHero().getTile() );
