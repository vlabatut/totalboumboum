	...
	{	
		...
		if(!blockL.isEmpty()){
			...
			for(int i = 0;i<blockL.size()-1;i++){
				...
				if(tiles.contains(blockL.get(i+1).getTile().getNeighbor(Direction.UP))){
				...
				if(tiles.contains(blockL.get(i+1).getTile().getNeighbor(Direction.LEFT))){
				...
				if(tiles.contains(blockL.get(i+1).getTile().getNeighbor(Direction.RIGHT))){
