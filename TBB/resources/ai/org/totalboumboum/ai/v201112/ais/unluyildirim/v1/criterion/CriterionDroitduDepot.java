 ...
 */
public class CriterionDroitduDepot extends AiUtilityCriterionBoolean
{	/** Nom de ce critère */
	 ...
	 */
	public CriterionDroitduDepot(UnluYildirim ai) throws StopRequestException
	{	// init nom
		super(NAME);
	...
	{	
	 ...
	 int bombe =0;
	 bombe=myhero.getBombNumberCurrent();
	 if(bombe!=0)
		 result=true ;
	return result;
	}
