...
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.AttaPertinence;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.AvanceItem;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.AvancePertinence;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.BestPertinence;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.ColPertinence;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.Duree;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.NombreDeMurs;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.NonConcurrence;
import org.totalboumboum.ai.v201112.ais.coskunozdemir.v2.criterion.Securite;
...
public class UtilityHandler extends AiUtilityHandler<CoskunOzdemir>
{
	...
	protected Set<AiTile> selectTiles() throws StopRequestException
	{
		...
		result.addAll( to.getAccessibleTiles() );
	...
	protected AiUtilityCase identifyCase( AiTile tile ) throws StopRequestException
	{
		...
		// mode is attacking
		{
			...
			for ( AiTile tt : to.getAccessibleTiles() )
			{
				ai.checkInterruption();
