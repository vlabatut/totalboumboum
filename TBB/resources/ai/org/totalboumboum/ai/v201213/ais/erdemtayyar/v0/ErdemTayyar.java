package org.totalboumboum.ai.v201213.ais.erdemtayyar.v0;
...
public class ErdemTayyar extends ArtificialIntelligence
{
	...
	@Override
	protected AiModeHandler<ErdemTayyar> getModeHandler() throws StopRequestException
	{	checkInterruption();
		return modeHandler;
	}

	@Override
	protected AiUtilityHandler<ErdemTayyar> getUtilityHandler() throws StopRequestException
	{	checkInterruption();
		return utilityHandler;
	}

	@Override
	protected AiBombHandler<ErdemTayyar> getBombHandler() throws StopRequestException
	{	checkInterruption();
		return bombHandler;
	}

	@Override
	protected AiMoveHandler<ErdemTayyar> getMoveHandler() throws StopRequestException
	{	checkInterruption();
		return moveHandler;
	}
