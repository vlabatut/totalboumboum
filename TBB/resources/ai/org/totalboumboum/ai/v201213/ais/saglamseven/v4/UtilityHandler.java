   ...
   defineUtilityValue(mode, combi, 10);
		...
		{	mode = AiMode.ATTACKING;
			...
			// il n'a qu'un seul critère, défini sur un domaine de 5 valeurs
			{
				...
				combi.setCriterionValue((CriterATTPertinence) criterionMap
						.get(CriterATTPertinence.NAME), Boolean.TRUE);
				combi.setCriterionValue(
						(CriterSecure) criterionMap.get(CriterSecure.NAME),
						Boolean.TRUE);
				combi.setCriterionValue(
						(CriterDistance) criterionMap.get(CriterDistance.NAME),
						0);
				defineUtilityValue(mode, combi, 11);
			...
			}
			{
				combi = new AiUtilityCombination(caseMap.get(PresenceUnEnnemi));
				combi.setCriterionValue((CriterATTPertinence) criterionMap
						.get(CriterATTPertinence.NAME), Boolean.FALSE);
				combi.setCriterionValue(
						(CriterSecure) criterionMap.get(CriterSecure.NAME),
						Boolean.TRUE);
				combi.setCriterionValue(
			...
			{	
				combi = new AiUtilityCombination(caseMap.get(MurDestAtt));
		           combi.setCriterionValue((CriterMurDest)criterionMap.get(CriterATTPertinence.NAME),3);
			...
			{	
				combi = new AiUtilityCombination(caseMap.get(MurDestAtt));
		           combi.setCriterionValue((CriterMurDest)criterionMap.get(CriterATTPertinence.NAME),2);
		           combi.setCriterionValue((CriterSecure)criterionMap.get(CriterSecure.NAME),Boolean.TRUE);
		           combi.setCriterionValue((CriterDistance)criterionMap.get(CriterDistance.NAME),0);
		            defineUtilityValue(mode, combi, 6);
			}
			{	
				combi = new AiUtilityCombination(caseMap.get(MurDestAtt));
		           combi.setCriterionValue((CriterMurDest)criterionMap.get(CriterATTPertinence.NAME),3);
		           combi.setCriterionValue((CriterSecure)criterionMap.get(CriterSecure.NAME),Boolean.TRUE);
		           combi.setCriterionValue((CriterDistance)criterionMap.get(CriterDistance.NAME),3);
		            defineUtilityValue(mode, combi, 4);
			}
			{	
				combi = new AiUtilityCombination(caseMap.get(MurDestAtt));
		           combi.setCriterionValue((CriterMurDest)criterionMap.get(CriterATTPertinence.NAME),1);
		           combi.setCriterionValue((CriterSecure)criterionMap.get(CriterSecure.NAME),Boolean.TRUE);
		           combi.setCriterionValue((CriterDistance)criterionMap.get(CriterDistance.NAME),0);
