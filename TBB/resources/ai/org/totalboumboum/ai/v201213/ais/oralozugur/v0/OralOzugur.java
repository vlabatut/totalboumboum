package org.totalboumboum.ai.v201213.ais.oralozugur.v0;
...
public class OralOzugur extends ArtificialIntelligence
{
	...
	@Override
	protected AiModeHandler<OralOzugur> getModeHandler() throws StopRequestException
	{	checkInterruption();
		return modeHandler;
	}

	@Override
	protected AiUtilityHandler<OralOzugur> getUtilityHandler() throws StopRequestException
	{	checkInterruption();
		return utilityHandler;
	}

	@Override
	protected AiBombHandler<OralOzugur> getBombHandler() throws StopRequestException
	{	checkInterruption();
		return bombHandler;
	}

	@Override
	protected AiMoveHandler<OralOzugur> getMoveHandler() throws StopRequestException
	{	checkInterruption();
		return moveHandler;
	}
