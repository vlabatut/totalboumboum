...
/**
 * Cette critere a été utilisé pour qu'on puisse détecter les agents qui se trouvent dans une case qui
 * est dans l'un des bombes portées. 
 * 
 * @author Doruk Kangal
...
public class PlusFacile extends AiUtilityCriterionBoolean<BesniliKangal> {
	...
	protected Boolean processValue( AiTile tile ) throws StopRequestException
	{
		...
		{
			ai.checkInterruption();
			return ai.getHeroOperation().isEnemyInDanger( ennemy );
		}
		return false;
	}
}
