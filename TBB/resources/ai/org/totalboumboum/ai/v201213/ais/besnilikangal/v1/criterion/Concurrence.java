...
/**
 * Cette critere est utilisé pour determiner la concurrence qui peut exister entre un des agents 
 * et notre agent. On considere la distance pour calculer la valeur de cette critere.
 * 
 * @author Doruk Kangal
...
public class Concurrence extends AiUtilityCriterionBoolean<BesniliKangal>
{
	...
	{
		ai.checkInterruption();
		int distance = ai.getZone().getTileDistance( ai.getHero().getTile(), tile );
