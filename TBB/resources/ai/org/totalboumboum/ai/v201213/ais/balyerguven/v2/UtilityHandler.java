...
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.Adversaire;
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.Duree;
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.Menace;
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.MurVoiAdv;
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.NbrMurDest;
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.Pertinence;
import org.totalboumboum.ai.v201213.ais.balyerguven.v2.criterion.PertinentCaseVide;
...
{	
	 ...
	 * 
	 */
	public List<AiTile> posibleTiles= ai.getZone().getTiles(); 
		...
		//Mode Attacking
			...
			if (!zone.getRemainingOpponents().isEmpty()) {
				...
				for(int i=0;i<myHero.getBombRange();i++){
					...
					if(myHero.getTile().getNeighbor(direction).equals(enemy)){
