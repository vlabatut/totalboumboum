...
{	
	...
	private static void loadReplayElement(Element root, Replay result) throws IllegalArgumentException, SecurityException, ParserConfigurationException, SAXException, IOException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException
	{	// level
	...
	private static void loadLevelElement(Element root, Replay result)
	{	// name
	...
	private static void loadDateElement(Element root, Replay result)
	{	// save
	...
	private static void loadPlayersElement(Element root, Replay result)
	...
	private static void loadPlayerElement(Element root, Replay result)
	{	// name
		String name = root.getAttributeValue(XmlNames.NAME);
