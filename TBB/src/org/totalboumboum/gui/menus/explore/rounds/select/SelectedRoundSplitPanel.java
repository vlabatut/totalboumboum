...
/*
 * Total Boum Boum
 * Copyright 2008-2012Vincent Labatut 
 * 
 ...
 *
 */
public class SelectedRoundSplitPanel extends SplitMenuPanel
{	private static final long serialVersionUID = 1L; 

	private BufferedImage image;

	public SelectedRoundSplitPanel(MenuContainer container, MenuPanel parent)
	{	super(container,parent,BorderLayout.LINE_START,GuiTools.VERTICAL_SPLIT_RATIO);
		...
		// panels
		setMenuPart(new SelectedRoundMenu(this,parent));
	}
