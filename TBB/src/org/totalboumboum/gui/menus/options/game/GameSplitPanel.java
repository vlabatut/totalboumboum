 ...
 *
 */
public class GameSplitPanel extends SplitMenuPanel
{	private static final long serialVersionUID = 1L;

	private BufferedImage image;

	public GameSplitPanel(MenuContainer container, MenuPanel parent)
	{	super(container,parent,BorderLayout.LINE_START,GuiTools.VERTICAL_SPLIT_RATIO);
		...
		// panels
		GameMenu menu = new GameMenu(this,parent);
		setMenuPart(menu);
	}
