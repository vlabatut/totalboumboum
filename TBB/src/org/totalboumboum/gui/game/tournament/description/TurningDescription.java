 ...
 */
public class TurningDescription extends TournamentDescription<TurningTournament> implements LimitsSubPanelListener
{	/** Class id */
	 ...
	 */
	public TurningDescription(SplitMenuPanel container)
	{	super(container);
