...
import org.totalboumboum.ai.v201415.adapter.communication.AiAction;
import org.totalboumboum.ai.v201415.adapter.communication.AiActionName;
...
import org.totalboumboum.ai.v201415.helper.AiParser;
...
{	
	...
	{	List<ControlEvent> result = new ArrayList<ControlEvent>();
		...
		// ceci ne devrait pas être possible (mais juste en cas...)
		if(value==null)
