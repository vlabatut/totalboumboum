...
{	
	public static TournamentConfiguration loadGameConfiguration() throws ParserConfigurationException, SAXException, IOException, IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException
	...
	private static void loadGameElement(Element root, TournamentConfiguration result) throws ParserConfigurationException, SAXException, IOException, IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException
	{	// tournament
	...
	private static void loadTournamentElement(Element root, TournamentConfiguration result) throws IllegalArgumentException, SecurityException, ParserConfigurationException, SAXException, IOException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException
	{	// players
	...
	private static void loadQuickMatchElement(Element root, TournamentConfiguration result) throws IllegalArgumentException, SecurityException, ParserConfigurationException, SAXException, IOException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException
	{	// name
	...
	private static void loadSettingsElement(Element root, TournamentConfiguration result)
	{	// levels 
		{	Element levelsElement = root.getChild(XmlTools.ELT_LEVELS);
			// random order
	...
	private static void loadQuickStartElement(Element root, TournamentConfiguration result) throws IllegalArgumentException, SecurityException, ParserConfigurationException, SAXException, IOException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException
	{	// name
