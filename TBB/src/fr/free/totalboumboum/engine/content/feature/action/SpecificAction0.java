...
public class SpecificAction0 extends AbstractAction
{
	/** 
	...
	private SpecificAction0(String name)
	{	super(name);
		actor = null;
		target = null;
		direction = null;
	...
	public SpecificAction0(String name, Sprite actor, Sprite target, Direction direction)
	{	super(name);
		this.actor = actor;
		this.target = target;
	...
	public SpecificAction0(String name, Sprite actor, Sprite target, Direction direction, Contact contact, TilePosition tilePosition, Orientation orientation)
	{	super(name);
		this.actor = actor;
		this.target = target;
		this.direction = direction;
	...
	{	boolean result = false;
		if(action instanceof SpecificAction0)
		{	SpecificAction0 a = (SpecificAction0)action;
			// name
