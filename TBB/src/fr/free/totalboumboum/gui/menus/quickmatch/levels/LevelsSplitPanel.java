...
public class LevelsSplitPanel extends SplitMenuPanel
{	private static final long serialVersionUID = 1L; 

	private BufferedImage image;
	
	public LevelsSplitPanel(MenuContainer container, MenuPanel parent)
	{	super(container,parent,BorderLayout.PAGE_END,GuiTools.HORIZONTAL_SPLIT_RATIO);
		...
		// panels
		LevelsMenu menu = new LevelsMenu(this,parent);
		setMenuPart(menu);
	}
	...
	{	((LevelsMenu)getMenuPart()).setTournament(tournament);
	}
	
	public MatchSplitPanel getTournamentPanel()
	{	return ((LevelsMenu)getMenuPart()).getTournamentPanel();		
	}
