...
public class QuickStartSplitPanel2 extends SplitMenuPanel
{	private static final long serialVersionUID = 1L;

	private BufferedImage image;

	public QuickStartSplitPanel2(MenuContainer container, MenuPanel parent)
	{	super(container,parent,BorderLayout.LINE_START,GuiTools.VERTICAL_SPLIT_RATIO);
		...
		// panels
		QuickStartMenu2 menu = new QuickStartMenu2(this,parent);
		setMenuPart(menu);
	}
