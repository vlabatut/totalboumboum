package fr.free.totalboumboum.gui.levels.select;
...
{	private static final long serialVersionUID = 1L;
	...
	{	super(container, parent);
		...
		buttonBack = GuiTools.createSecondaryVerticalMenuButton(GuiTools.MENU_LEVEL_BUTTON_BACK,this);
		add(Box.createVerticalGlue());		
	...
	{	if(e.getActionCommand().equals(GuiTools.MENU_LEVEL_BUTTON_BACK))
		{	replaceWith(parent);
	    }
	} 
