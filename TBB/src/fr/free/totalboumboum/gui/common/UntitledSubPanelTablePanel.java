...
public class UntitledSubPanelTablePanel extends JPanel
...
//	private Configuration configuration;
	...
	public UntitledSubPanelTablePanel(int width, int height, int columns, int lines, boolean header, GuiConfiguration configuration)
	{	// init
