...
public class GuiKeys
{
	...
	/* QUICKMATCH */	
		...
		/* PLAYERS */
			...
			/* CONTROLS */
			public static final String MENU_QUICKMATCH_PLAYERS_CONTROLS_NEXT = MENU_QUICKMATCH_PLAYERS+"ControlsNext";
			public static final String MENU_QUICKMATCH_PLAYERS_CONTROLS_PREVIOUS = MENU_QUICKMATCH_PLAYERS+"ControlsPrevious";
			public static final String MENU_QUICKMATCH_PLAYERS_CONTROLS_VALUE = MENU_QUICKMATCH_PLAYERS+"ControlsValue";
			/* COLOR */
			public static final String MENU_QUICKMATCH_PLAYERS_COLOR_NEXT = MENU_QUICKMATCH_PLAYERS+"ColorNext";
			public static final String MENU_QUICKMATCH_PLAYERS_COLOR_PREVIOUS= MENU_QUICKMATCH_PLAYERS+"ColorPrevious";
			public static final String MENU_QUICKMATCH_PLAYERS_COLOR_VALUE = MENU_QUICKMATCH_PLAYERS+"ColorValue";
			/* HERO */
			public static final String MENU_QUICKMATCH_PLAYERS_HERO_BROWSE = MENU_QUICKMATCH_PLAYERS+"HeroBrowse";
			public static final String MENU_QUICKMATCH_PLAYERS_HERO_NEXT = MENU_QUICKMATCH_PLAYERS+"HeroNext";
			public static final String MENU_QUICKMATCH_PLAYERS_HERO_PREVIOUS = MENU_QUICKMATCH_PLAYERS+"HeroPrevious";
			public static final String MENU_QUICKMATCH_PLAYERS_HERO_VALUE = MENU_QUICKMATCH_PLAYERS+"HeroValue";
			/* PROFILE */
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_BROWSE = MENU_QUICKMATCH_PLAYERS+"ProfileBrowse";
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_CANCEL = MENU_QUICKMATCH_PLAYERS+"ProfileCancel";
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_CONFIRM = MENU_QUICKMATCH_PLAYERS+"ProfileConfirm";
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_DELETE = MENU_QUICKMATCH_PLAYERS+"ProfileDelete";
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_NEXT = MENU_QUICKMATCH_PLAYERS+"ProfileNext";
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_PREVIOUS = MENU_QUICKMATCH_PLAYERS+"ProfilePrevious";
			public static final String MENU_QUICKMATCH_PLAYERS_PROFILE_VALUE = MENU_QUICKMATCH_PLAYERS+"ProfileValue";
			/* TYPE */
			...
			public static final String MENU_QUICKMATCH_PLAYERS_TYPE_VALUE = MENU_QUICKMATCH_PLAYERS+"TypeValue";
